...
<html lang="en">
  ...
  <div class="container" style="margin-top: 100px;">
    ...
    <br>
    <p><strong>
      Body transformation is a process that comprises making significant changes to an individual's physical body and overall body composition led through exercises, nutrition, or lifestyle modifications. This majorly includes the compulsive alteration to the percentage of body fat, muscle mass, and body shape.</strong>  
    </p>
    <p1>
     Results<br>
The results of hard work can be remarkable, and can include feeling healthier, stronger, and more confident. <br>
     Mental health<br>
Working out can help people cope with depression and other negative feelings. <br>
     Process<br>
A successful transformation involves thinking and acting like someone who is in great shape. This includes enjoying the process, looking for opportunities to move, and eating nourishing food. <br>
    Consistency<br>
Small changes over time are more effective than big changes that are one-off events. 
    Realistic expectations<br>
Body transformation is a journey that varies from person to person, and it's important to have realistic expectations.<br> 
    Guidance<br>
A knowledgeable coach can provide guidance and support. Healthcare professionals and specialists can also help navigate the transformation process. <br>
    Stages<br>
The stages of a gym transformation include mass gain, fat loss, and maintenance. The amount of time spent in each stage depends on your physique goals. <br>
<br>
    Some tips for a successful gym transformation include:<br> 
1.Starting with small steps, like going to the gym three times a week <br>
2.Gradually increasing the number of workouts and caloric deficit <br>
3.Maintaining consistency <br>
4.Setting goals <br>
5.Prioritizing self-care<br>
    </p1>
<br>
<hr>
<br>
<h3>here are some transformations</h3>
    <div class="image-gallery">

        <img src="images/transformation 1.jpg" alt="Image 1">

        <img src="images/transformation 2.jpg" alt="Image 2">

        <!-- <img src="E:\brothers gym website\transformation 3.jpg" alt="Image 3"> -->
